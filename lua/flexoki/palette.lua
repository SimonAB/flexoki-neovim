...
local variants = {
	...
	light_high_contrast = {
		...
		['ui-2']   = base_colors['flexoki-150'],
		['ui-3']   = base_colors['flexoki-200'],
		-- Only darken the most subtle text; keep `tx-2` unchanged to avoid shifting
		-- operators and other mid-tone UI elements compared to upstream light.
		['tx-3']   = base_colors['flexoki-500'],
		['tx-2']   = base_colors['flexoki-600'],
		['tx']     = base_colors['flexoki-black'],
		['re']     = base_colors['flexoki-red-600'],
		['re-2']   = base_colors['flexoki-red-400'],
